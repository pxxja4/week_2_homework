...
# Wildcards are special characters that represent one or more unknown characters and are useful for searching for patterns in text/filenames or databases --
# --where you dont know the exact value but need to find something similar
...
# the above "for file in file_list" statement is looking at the files in the files list
...
# this has allowed us to print just the filenames without the directory path (\users\khris), making this more user-friendly
#
